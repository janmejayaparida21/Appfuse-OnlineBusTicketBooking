...
<html lang="en">
    ...
    <style>
        .body {
            background : url("images/bus1.jpg");
        }
        .carousel-inner img {
    ...
    <body id="page-top" >
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <form>
                        <ul class="nav navbar-nav navbar-right">
                           ...
                           <li class="dropdown">
                            <a class="dropdown-toggle" data-toggle="dropdown" style = " font-size:large;" "href="#">Hi!! ${pageContext.request.remoteUser}
                            <span></span></a>
        ...
        <header>
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <img class="img-responsive" src="images/load.gif" alt="">
