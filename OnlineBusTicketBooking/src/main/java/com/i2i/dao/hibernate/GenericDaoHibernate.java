 ...
 * <pre>
 *      &lt;bean id="fooDao" class="com.i2i.dao.hibernate.GenericDaoHibernate"&gt;
 *          &lt;constructor-arg value="com.i2i.model.Foo"/&gt;
 *      &lt;/bean&gt;
 * </pre>
 *
...
public class GenericDaoHibernate<T, PK extends Serializable> implements GenericDao<T, PK> {
    ...
    public SessionFactory getSessionFactory() {
    	System.out.println("Getting Session Factory : " + this.sessionFactory);
    ...
    public Session getSession() throws HibernateException { 
        ...
        }System.out.println("Getting session.." + sess );
        return sess;
    }
